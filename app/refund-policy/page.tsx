        ...
        >
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li>Navigate to &ldquo;My Courses&rdquo; or &ldquo;My Account&rdquo;</li>
              <li>Find the course you wish to cancel</li>
              <li>Click &ldquo;Cancel Booking&rdquo; or &ldquo;Request Refund&rdquo;</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>Medical certificate or doctor&rsquo;s note</li>
