...
export function FilterSidebar({ filters, setFilters, clearFilters, filteredCoursesCount, onClose, environmentOptions, difficultyOptions, minPrice = 0, maxPrice = 1000, onPriceSliderChange, minDuration = 1, maxDuration = 40, onDurationSliderChange }: FilterSidebarProps) {
  ...
  return (
    ...
    >
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              {[
                ...
                { value: "Subsistence Living", label: "Subsistence Living" },
                { value: "Tactical Training", label: "Tactical Training" },
              ].map((type) => (
      ...
      <div className="sticky bottom-0 left-0 right-0 bg-black p-6 border-t border-zinc-800 z-10">
