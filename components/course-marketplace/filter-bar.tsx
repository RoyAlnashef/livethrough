...
export function FilterBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t md:sticky md:top-0 md:left-auto md:right-auto md:border-t-0 md:border-b border-zinc-800 bg-black pb-safe">
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => {
                          if (checked) {
                            setFilters({
                              ...filters,
                              courseTypes: [...filters.courseTypes, type],
                            })
                          } else {
                            setFilters({
                              ...filters,
                              courseTypes: filters.courseTypes.filter((t) => t !== type),
                            })
                          }
                        }}
                      />
