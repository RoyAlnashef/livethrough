...
export function Header() {
  ...
  return (
    <header className="border-b border-zinc-800 bg-black/95 backdrop-blur supports-[backdrop-filter]:bg-black/60 font-sans md:relative fixed top-0 left-0 right-0 z-50">
